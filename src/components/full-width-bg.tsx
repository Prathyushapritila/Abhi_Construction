...
export function FullWidthBg({ 
  ...
  return (
    <section className={`relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-x-hidden overflow-y-visible min-h-[65vh] sm:min-h-[70vh] md:min-h-[75vh] lg:min-h-[80vh] w-screen ${className}`}>
      {/* Background Image */}
      <motion.div
        className="absolute inset-0 z-0 bg-stone-900 dark:bg-slate-900 w-full left-0 right-0"
      ...
      {/* Content */}
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 max-w-7xl relative z-20">
