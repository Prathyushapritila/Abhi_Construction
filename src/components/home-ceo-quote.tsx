...
export function HomeCEOQuote() {
  return (
    <section className="relative section-standard quote-section-no-scrollbar" style={{ overflow: 'visible', overflowX: 'hidden', overflowY: 'visible', height: 'auto', maxHeight: 'none' }}>
