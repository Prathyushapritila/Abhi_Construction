    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <span className="absolute -left-4 md:-left-8 top-0 text-premiumGold text-6xl md:text-8xl font-serif opacity-20 dark:opacity-30">&ldquo;</span>
            ...
            <span className="absolute -right-4 md:-right-8 bottom-0 text-premiumGold text-6xl md:text-8xl font-serif opacity-20 dark:opacity-30">&rdquo;</span>
          </motion.blockquote>
