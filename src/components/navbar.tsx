        ...
        >
          <div className="relative flex items-center flex-shrink-0">
            <Image
              ...
              width={240}
              height={120}
              className="h-14 sm:h-16 md:h-20 lg:h-24 xl:h-28 w-auto max-w-[140px] sm:max-w-[180px] md:max-w-[240px] object-contain drop-shadow-2xl transition-all duration-300 group-hover:scale-110 dark:brightness-110 dark:contrast-110 dark:drop-shadow-[0_0_20px_rgba(255,165,0,0.5)]"
              priority
              sizes="(max-width: 640px) 140px, (max-width: 768px) 180px, (max-width: 1024px) 240px, 280px"
            />
          </div>
          <span className="text-[15px] sm:text-[18px] md:text-[20px] font-semibold text-[#E37B29] dark:text-white leading-none whitespace-nowrap hidden sm:inline">
