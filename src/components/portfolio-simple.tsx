            ...
            return (
              ...
              >
                <Button
                  ...
                  className={cn(
                    "flex items-center justify-center space-x-2 rounded-full border-2 px-6 py-3 text-base font-semibold transition-all duration-250 min-w-[140px] shadow-sm group cursor-pointer focus:outline-none focus:ring-2 focus:ring-premiumGold focus:ring-offset-2",
                    isActive
                      ...
                      : "border-royalNavy text-royalNavy dark:border-slate-200 dark:text-slate-200 hover:bg-premiumGold hover:border-premiumGold hover:text-white dark:hover:text-white hover:shadow-xl dark:hover:shadow-xl"
                  )}
                >
                <Icon 
                  className={cn(
                    "h-4 w-4 flex-shrink-0 transition-colors duration-250",
